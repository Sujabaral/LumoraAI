...
PANIC_PHRASES = {
    ...
    "feel like i'm dying", "feel like i am dying",
    "about to faint", "going to faint", "i will faint",
    "my heart is racing", "heart racing", "palpitations",
    "chest tight", "chest tightness", "short of breath",
    "i'm shaking", "im shaking", "trembling",
    "panic", "panic attack"
}
